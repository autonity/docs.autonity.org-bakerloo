...
1. **An EVM compatible wallet** (e.g., Rabby, MetaMask, WalletConnect, Coinbase Wallet) with the Autonity Bakerloo network added to it.
    ...
    - To add the Autonity network to your wallet, visit [chainlist.org](https://chainlist.org/?testnets=true&search=bakerloo) where you can connect your wallet and add the network automatically. Alternatively, you can manually add it by entering the details found [here](https://docs.autonity.org/networks/testnet-bakerloo/#bakerloo-testnet-details).
2. **Collateral**
    ...
    - To get USDz, please see the subsequent section *How to get ATN and USDz on Autonity Bakerloo*. Add the address of USDz on Bakerloo to your wallet so you can view your balance: `0x7914e33423232885C1a3350c26bb420d23Ff31Bb`. 
3. **Auton (ATN)**
    ...
    - On Bakerloo, ATN can be acquired through the faucet: [https://autonity.faucetme.pro/](https://autonity.faucetme.pro/)


## How to get ATN and USDz on Autonity Bakerloo

1. Receive funding by visiting [https://proto-afp.pages.dev/get-funded](https://proto-afp.pages.dev/get-funded) and filling out the form. This will require you to sign a message using your EVM compatible wallet to prove ownership of your wallet. 
2. Once funded, you will receive USDz, the play-money collateral token used in the AFP on Bakerloo, and a minimal amount of ATN to pay for gas on the Bakerloo network. Additional ATN can be requested through the dedicated faucet: [https://autonity.faucetme.pro/](https://autonity.faucetme.pro/)


## How to create and fund a margin account on the AFP

As highlighted in the [Overall Architecture](architecture.qmd), interaction with the AFP is not limited to a single front-end and collateral can be deposited by various methods (e.g. SDK, direct on-chain calls). However, for the ease of onboarding, the front-end of the first exchange built on the AFP, the AutEx, can also be used to deposit collateral to a margin account.
