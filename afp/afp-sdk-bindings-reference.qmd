---
title: "Smart Contract Python Bindings Reference"
---
...
- [**SystemViewer**](#afp.bindings.SystemViewer) – SystemViewer contract binding.
...
- [**UserMarginAccountData**](#afp.bindings.UserMarginAccountData) – Port of `struct UserMarginAccountData` on the ISystemViewer contract.
...
- [**side**](#afp.bindings.BidData.side) (<code>[Side](#afp.bindings.clearing_facet.Side)</code>) –
...
- **laas** (<code>[List](#typing.List)\[[List](#typing.List)\[[ChecksumAddress](#eth_typing.ChecksumAddress)\]\]</code>) –
...
- [**auction_config**](#afp.bindings.Config.auction_config) (<code>[AuctionConfig](#afp.bindings.auctioneer_facet.AuctionConfig)</code>) –
...
Bases: <code>[SystemViewer](#afp.bindings.system_viewer.SystemViewer)</code>
...
- [**clearing**](#afp.bindings.SystemViewer.clearing) – Binding for `clearing` on the SystemViewer contract.
- [**initialize**](#afp.bindings.SystemViewer.initialize) – Binding for `initialize` on the SystemViewer contract.
- [**mae_by_collateral_asset**](#afp.bindings.SystemViewer.mae_by_collateral_asset) – Binding for `maeByCollateralAsset` on the SystemViewer contract.
- [**mae_by_collateral_assets**](#afp.bindings.SystemViewer.mae_by_collateral_assets) – Binding for `maeByCollateralAssets` on the SystemViewer contract.
- [**mae_checks_by_collateral_asset**](#afp.bindings.SystemViewer.mae_checks_by_collateral_asset) – Binding for `maeChecksByCollateralAsset` on the SystemViewer contract.
- [**margin_account_registry**](#afp.bindings.SystemViewer.margin_account_registry) – Binding for `marginAccountRegistry` on the SystemViewer contract.
- [**owner**](#afp.bindings.SystemViewer.owner) – Binding for `owner` on the SystemViewer contract.
- [**positions_by_collateral_asset**](#afp.bindings.SystemViewer.positions_by_collateral_asset) – Binding for `positionsByCollateralAsset` on the SystemViewer contract.
- [**positions_by_collateral_assets**](#afp.bindings.SystemViewer.positions_by_collateral_assets) – Binding for `positionsByCollateralAssets` on the SystemViewer contract.
- [**product_details**](#afp.bindings.SystemViewer.product_details) – Binding for `productDetails` on the SystemViewer contract.
- [**product_registry**](#afp.bindings.SystemViewer.product_registry) – Binding for `productRegistry` on the SystemViewer contract.
- [**product_states**](#afp.bindings.SystemViewer.product_states) – Binding for `productStates` on the SystemViewer contract.
- [**proxiable_uuid**](#afp.bindings.SystemViewer.proxiable_uuid) – Binding for `proxiableUUID` on the SystemViewer contract.
- [**renounce_ownership**](#afp.bindings.SystemViewer.renounce_ownership) – Binding for `renounceOwnership` on the SystemViewer contract.
- [**transfer_ownership**](#afp.bindings.SystemViewer.transfer_ownership) – Binding for `transferOwnership` on the SystemViewer contract.
- [**upgrade_interface_version**](#afp.bindings.SystemViewer.upgrade_interface_version) – Binding for `UPGRADE_INTERFACE_VERSION` on the SystemViewer contract.
- [**upgrade_to_and_call**](#afp.bindings.SystemViewer.upgrade_to_and_call) – Binding for `upgradeToAndCall` on the SystemViewer contract.
- [**user_margin_data_by_collateral_asset**](#afp.bindings.SystemViewer.user_margin_data_by_collateral_asset) – Binding for `userMarginDataByCollateralAsset` on the SystemViewer contract.
- [**user_margin_data_by_collateral_assets**](#afp.bindings.SystemViewer.user_margin_data_by_collateral_assets) – Binding for `userMarginDataByCollateralAssets` on the SystemViewer contract.
- [**valuations**](#afp.bindings.SystemViewer.valuations) – Binding for `valuations` on the SystemViewer contract.

**Attributes:**

- [**Initialized**](#afp.bindings.SystemViewer.Initialized) (<code>[ContractEvent](#web3.contract.contract.ContractEvent)</code>) – Binding for `event Initialized` on the SystemViewer contract.
- [**OwnershipTransferred**](#afp.bindings.SystemViewer.OwnershipTransferred) (<code>[ContractEvent](#web3.contract.contract.ContractEvent)</code>) – Binding for `event OwnershipTransferred` on the SystemViewer contract.
- [**Upgraded**](#afp.bindings.SystemViewer.Upgraded) (<code>[ContractEvent](#web3.contract.contract.ContractEvent)</code>) – Binding for `event Upgraded` on the SystemViewer contract.
...
- **\_clearing** (<code>[ChecksumAddress](#eth_typing.ChecksumAddress)</code>) –
- **\_product_registry** (<code>[ChecksumAddress](#eth_typing.ChecksumAddress)</code>) –
- **\_margin_account_registry** (<code>[ChecksumAddress](#eth_typing.ChecksumAddress)</code>) –
...
- <code>[List](#typing.List)\[[int](#int)\]</code> –
...
- **collateral_assets** (<code>[List](#typing.List)\[[ChecksumAddress](#eth_typing.ChecksumAddress)\]</code>) –
- **accounts** (<code>[List](#typing.List)\[[ChecksumAddress](#eth_typing.ChecksumAddress)\]</code>) –
...
- <code>[List](#typing.List)\[[bool](#bool)\]</code> –
- <code>[List](#typing.List)\[[int](#int)\]</code> –
- <code>[List](#typing.List)\[[int](#int)\]</code> –
...
- <code>[List](#typing.List)\[[List](#typing.List)\[[PositionData](#afp.bindings.margin_account.PositionData)\]\]</code> –
...
- <code>[List](#typing.List)\[[Product](#afp.bindings.product_registry.Product)\]</code> –
...
- <code>[List](#typing.List)\[[ProductState](#afp.bindings.product_registry.ProductState)\]</code> –
...
- <code>[List](#typing.List)\[[UserMarginAccountData](#afp.bindings.system_viewer.UserMarginAccountData)\]</code> –
...
- [**SequenceExecuted**](#afp.bindings.TradingProtocol.SequenceExecuted) (<code>[ContractEvent](#web3.contract.contract.ContractEvent)</code>) – Binding for `event SequenceExecuted` on the TradingProtocol contract.
...
- **trades** (<code>[List](#typing.List)\[[Trade](#afp.bindings.clearing_facet.Trade)\]</code>) –
- **fallback_on_failure** (<code>[bool](#bool)</code>) –
...
- [**collateral_asset**](#afp.bindings.UserMarginAccountData.collateral_asset) (<code>[ChecksumAddress](#eth_typing.ChecksumAddress)</code>) –
- [**mae**](#afp.bindings.UserMarginAccountData.mae) (<code>[int](#int)</code>) –
- [**margin_account_id**](#afp.bindings.UserMarginAccountData.margin_account_id) (<code>[ChecksumAddress](#eth_typing.ChecksumAddress)</code>) –
- [**mmu**](#afp.bindings.UserMarginAccountData.mmu) (<code>[int](#int)</code>) –
- [**positions**](#afp.bindings.UserMarginAccountData.positions) (<code>[List](#typing.List)\[[PositionData](#afp.bindings.margin_account.PositionData)\]</code>) –
