...
2. Run an [MAE Check](/afp/margin-intent-accounts.qmd#margin-account-equity-mae-check) on the liquidator’s Margin Account for the corresponding Collateral Asset and the specified products and prices. In case of failure, the bid is rejected.
