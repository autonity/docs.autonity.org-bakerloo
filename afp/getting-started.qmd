...
2. **Collateral**
    ...
    - Add the address of USDz on Bakerloo to your wallet so you can view your balance: `0x7914e33423232885C1a3350c26bb420d23Ff31Bb`. 
3. **Auton (ATN)**
    ...
    - On Bakerloo, ATN can be acquired through the fauct: https://autonity.faucetme.pro/


## How to get ATN and USDC on Autonity Mainnet

1. You will need USDC on another blockchain (e.g. Polygon, Avalanche, Base, Optimism, Ethereum – see the full list [here](https://chainlist.org/?search=usdc)) that you will then be able to bridge over to Autonity. To purchase USDC on one of these blockchains you can deposit funds on a centralised exchange and purchase it there with fiat before moving it to your EVM wallet.
...
3. Use some of your USDC to purchase a minimal amount of additional ATN to ensure you don’t run out of gas and strand your collateral. This can be done on a DEX such as the DAX.
